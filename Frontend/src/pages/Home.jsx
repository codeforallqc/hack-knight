...
export default function Home() {
  return (
    <main>                                          {/* <main> is the semantic HTML wrapper for the page's primary content */}
      ...
      <SponsorsCarousel />                          {/* section 6: sponsor logos carousel + "View All Sponsors" link */}
